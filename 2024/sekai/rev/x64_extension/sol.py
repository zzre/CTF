# https://nofix.re/posts/2023-29-08-barbhack2023-encrypted_box.markdown/
def xor(a, b):
...
keys = []
keys.append(p64(0x1716151413121110)+p64(0x1f1e1d1c1b1a1918))
keys.append(p64(0x98c476b39fc273b7)+p64(0x9cc072b793ce7fbb))
keys.append(p64(0xdabe44adcda851b9)+p64(0xdeba40a9c1a45db5))
keys.append(p64(0xd41bf13e4cdf878d)+p64(0xdb15fc3247d58e85))
keys.append(p64(0xae4fa53774f1e19a)+p64(0xb151b82b6febf882))
keys.append(p64(0x690ca7e8bd1756d6)+p64(0xf5ccd55f2ed9296d))
keys.append(p64(0x3cf5476292bae255)+p64(0xe24f07cb531ebfe0))

keys.append(p64(0xcb837541a28fd2a9)+p64(0x10968973e55a5c2c))
keys.append(p64(0x64df02b8582a45da)+p64(0xd58eba9337c1bd58))
keys.append(p64(0xb50fbec67e8ccb87)+p64(0x40c36b995055e2ea))
keys.append(p64(0x35db388c51043a34)+p64(0xd7943f47021a85d4))
keys.append(p64(0x6b8d5761de82e9a7)+p64(0x7b1bde123bd8b58b))
keys.append(p64(0x45701f7170ab27fd)+p64(0x90fea5e2476a9aa5))
keys.append(p64(0x2d6f05a646e252c7)+p64(0x6dac6e3f16b7b02d))

with open("flag.txt.enc", "rb") as f:
    enc = f.read()

txt = bytes.fromhex('fa94 cd0e 72b3 205a 6c13 44a1 c0bd 9a9d'.replace(' ', ''))

c0 = bytes(range(0xff, 0xf0-1, -1))
c1 = bytes(range(0x10))

flag = b''
for i in range(0, len(enc), 16):
    txt = enc[i:i+16]
    txt = cipher.AESDECLAST(txt, keys[13])
    for j in range(12, -1, -1):
        txt = cipher.AESENCINV(txt, keys[j])

    txt = xor(xor(txt, c0), c1)
    print(txt)
    flag += txt
